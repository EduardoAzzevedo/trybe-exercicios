...
// lucro (valor de venda descontado o custo do produto) a empresa terá ao vender mil 
// desses produtos.
...
if (valorCusto >= 0 || valorVenda >= 0 || valorCustoTotal >= 0 || lucro >= 0) {
    console.log(lucro * 1000);
} else {
    console.log('Erro! Programa irá se incerrar!');
}
